...
- [Promptify](https://github.com/promptslab/Promptify) - ![Repo stars of Helicone](https://img.shields.io/github/stars/Helicone/helicone?style=social) - Open-source LLM observability platform for logging, monitoring, and debugging AI applications. 
